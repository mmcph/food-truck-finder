...
//
$truck1 = new Truck(generateUuidV4(), $profile1->getProfileId(), "stuff about this truck", 1, 35.0855339,-106.6489636 , "taco tuesday truck", "505-987-6547", "tacotruck.com");
$truck1->insert($pdo);
echo "1st truck";

$truck2 = new Truck(generateUuidV4(), $profile2->getProfileId(), "more stuff about this truck", 1, 35.0724782,-106.7428438, "marios pizza truck", "505-987-5447", "pizzatruck.com");
$truck2->insert($pdo);
echo "second truck";

$truck3= new Truck(generateUuidV4(), $profile3->getProfileId(), "We serve many types of tacos, including carne adovada, carnitas, chicken and more - stop by and try some out!", 1, 35.0694904,-106.5888267, "Pablo's Tacos", "505-987-5227", "pablostacos.com");
$truck3->insert($pdo);
echo "3rd truck";
