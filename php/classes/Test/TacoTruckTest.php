...
//todo not sure about this file path, or if it is installed at all
 ...
 **/
abstract class TacoTruckTest extends TestCase {
    //todo not sure about the TestCase or what/where it is
    use TestCaseTrait;
    /**
    ...
    public final function getDataSet() : QueryDataSet {
        ...
        $dataset->addTable("truckCategory");
    ...
    public final function getConnection() : Connection {
        ...
        if($this->connection === null) {
            ...
            $config = readConfig("/etc/apache2/capstone-mysql/foodtruck.ini");
